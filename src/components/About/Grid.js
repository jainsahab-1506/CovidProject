          ...
          <div className="col-lg-6 mbr-col-md-10">
            <div className="wrap">
              <div className="text-wrap vcenter">
                <h6 class="mbr-fonts-style text1 mbr-text display-7">
                  TOTAL CASES IN INDIA
                </h6>
                <Link to="/statepage">
                  <h2>{fetchdata.statewise[0].confirmed}</h2>
                </Link>
              </div>
            </div>
          </div>
          <div className="col-lg-6 mbr-col-md-10">
            <div className="wrap">
              <div className="text-wrap vcenter">
                ...
                <h2>
                  {
                    fetchdata.tested[fetchdata.tested.length - 1][
