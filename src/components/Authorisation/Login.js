...
export default function Login() {
  ...
  <form method="POST">
    ...
    <div className="form-group">
      <button type="submit" 
      className="btn btn-primary btn-lg" onClick={HandleSubmit}>LOG IN</button>
    </div>
  </form>
  <div className="text-center">Don't have an account? <a href="/signup">create an account here</a></div>
</div>
